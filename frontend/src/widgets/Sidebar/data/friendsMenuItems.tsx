...
export const friendsMenuItems: MenuProps['items'] = [
    {
        label: (
            <button onClick={() =>{  friendsTabStore.switchTab('add'); mobileMenuStore.changeActive(false)}} className='w-full flex justify-between items-center'>
    ...
    {
        label: (
            <button onClick={() => { friendsTabStore.switchTab('list'); mobileMenuStore.changeActive(false)}} className='w-full flex justify-between items-center'>
                <div className='flex gap-[10px]'>
    ...
    {
        label: (
            <button onClick={() => { friendsTabStore.switchTab('send'); mobileMenuStore.changeActive(false)}} className='w-full justify-between flex items-center'>
                <div className='flex gap-[10px]'>
